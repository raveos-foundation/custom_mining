...
-   каталог **RAVINOS** c файлом конфигурации пакета майнера **manifest.json** и
    двумя файлами скрипта на языке **python** (**start.py** и **stats.py**).
    Структура файлов подробнее – в соответствующем разделе.

1.  Данные монеты: алгоритм и тип
