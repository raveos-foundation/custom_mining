...
```
   STRATUM_PROTO_TYPE_TCP   = 0x1
   STRATUM_PROTO_TYPE_SSL   = 0x2
   STRATUM_PROTO_TYPE_HTTP  = 0x4
   STRATUM_PROTO_TYPE_TLS   = 0x8
   
   STRATUM_MODE_ETH_PROXY   = 0x10
   STRATUM_MODE_QTMINER     = 0x20
   STRATUM_MODE_MINER_PROXY = 0x40
   STRATUM_MODE_NICEHASH    = 0x80
```
